!function(e, t, o, r, n, i, s, c, u, l, a, d, p, m) {
    for ((a = e.QrCode = e.QrCode || {}).components = u,
    ...
    function(e, t, o) {
        ...
        o.componentOnReady || (o.componentOnReady = function() {
            var t = this;
            function o(o) {
                if (t.nodeName.indexOf("-") > 0) {
                    for (var r = e["s-apps"], n = 0, i = 0; i < r.length; i++)
                        if (e[r[i]].componentOnReady) {
                            if (e[r[i]].componentOnReady(t, o))
                                return;
                            n++
                        }
                    if (n < r.length)
                        return void (e["s-cr"] = e["s-cr"] || []).push([t, o])
                }
                o(null)
            }
            return e.Promise ? new e.Promise(o) : {
                then: o
            }
        }
        )
    ...
    !n && p && (n = p),
    !n && m.src && (n = (p = m.src.split("/").slice(0, -1)).join("/") + (p.length ? "/" : "")),
    d = t.createElement("script"),
    function(e, t, o, r) {
        return !(t.search.indexOf("core=esm") > 0) && (!(!(t.search.indexOf("core=es5") > 0 || "file:" === t.protocol) && e.customElements && e.customElements.define && e.fetch && e.CSS && e.CSS.supports && e.CSS.supports("color", "var(--c)") && "noModule"in o) || function(e) {
            try {
    ...
    }(e, e.location, d) ? d.src = n + "qr-code.y9wpr14h.js" : (d.src = n + "qr-code.orxjfzvr.js",
